 ...
 */
Slices::Slices(Scene * _scene, unsigned char * _sliceColormap, Toirt_Samhlaigh & _toirt_samhlaigh, Volume * _volume) :
    GLMotif::PopupWindow("SlicesPopup", Vrui::getWidgetManager(), "Slices"), scene(_scene), sliceColormap(_sliceColormap),
            toirt_samhlaigh(_toirt_samhlaigh), volume(_volume) {
    initialize();
}
...
void Slices::changeSlicesColorMapCallback(GLMotif::RadioBox::ValueChangedCallbackData * callBackData) {
    ...
    toirt_samhlaigh.setSliceColorMapChanged(true);
    Vrui::requestUpdate();
...
void Slices::createXSlices(GLMotif::RowColumn * & xyzSlicesRowColumn, const GLMotif::StyleSheet & styleSheet) {
    ...
    xSliceSlider->setValueRange(0.0, float(volume->getWidth() - 1), 1.0);
...
void Slices::createYSlices(GLMotif::RowColumn * & xyzSlicesRowColumn, const GLMotif::StyleSheet & styleSheet) {
    ...
    ySliceSlider->setValueRange(0.0, float(volume->getHeight() - 1), 1.0);
...
void Slices::createZSlices(GLMotif::RowColumn * & xyzSlicesRowColumn, const GLMotif::StyleSheet & styleSheet) {
    ...
    zSliceSlider->setValueRange(0.0, float(volume->getDepth() - 1), 1.0);
 ...
 */
void Slices::exportSlicesColorMap(unsigned char * colormap) const {
...
/*
 * loadColorMap - Load a slice color map.
 *
 * parameter fileName - const char*
 */
void Slices::loadColorMap(const char* fileName) {
...
/*
 * saveColorMap - Save the slice color map.
 *
 * parameter fileName - const char *
 */
void Slices::saveColorMap(const char * fileName) const {
